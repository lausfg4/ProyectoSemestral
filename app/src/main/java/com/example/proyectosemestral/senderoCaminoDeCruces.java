...
public class senderoCaminoDeCruces extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sendero_camino_de_cruces);
        ...
        btnComentar.setOnClickListener(v -> {
            ...
            intent.putExtra("sendero_id", 2); // ID del sendero El Pescador
            intent.putExtra("sendero_nombre", "Sendero Camino De Cruces");
