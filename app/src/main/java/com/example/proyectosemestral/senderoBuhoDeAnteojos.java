...
public class senderoBuhoDeAnteojos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sendero_el_pescador);
        ...
        btnComentar.setOnClickListener(v -> {
            ...
            intent.putExtra("sendero_id", 4); // ID del sendero El Pescador
            intent.putExtra("sendero_nombre", "Sendero Búho de Anteojos");
